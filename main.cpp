...
int main() {
    ...
    Shader shader("../../Project/shader.vs", "../../Project/shader.fs");
    ...
    unsigned char* data = stbi_load("../../Project/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    data = stbi_load("../../Project/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform1f(glGetUniformLocation(shader.ID, "value"), value);
...
void processInput(GLFWwindow* window)
{
    ...
    const float changeSpeed = 0.5 * deltaTime;
